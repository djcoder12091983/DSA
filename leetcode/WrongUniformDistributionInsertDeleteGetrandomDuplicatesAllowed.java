...
// TODO BUG FIX - 30/32 passed -- NEED TO THINK whether TEST CASES may be wrong or Problem statement is ambigous/wrong
...
class RandomizedCollection {
    ...
    public boolean remove(int val) {
        ...
        System.out.println("REMOVE: " + val + " RC: " + rc);
        ...
        if(returned.containsKey(val)) {
            ...
            System.out.println("V: " + val + " F1: " + f1 + " F2: " + f2);
            if(f1 == f2) {
                returned.remove(val);
            }
        }
