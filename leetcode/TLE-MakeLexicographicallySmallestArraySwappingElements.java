...
// TODO -- even with track TreeMap we run a while loop to swap repeatedly -- this needs to be optimized
...
class Solution {
    ...
    public int[] lexicographicallySmallestArray(int[] A, int limit) {
        ...
        for(int i = 0; i < N; i++) {
            ...
            // now look suitable item on right side repeatedly
