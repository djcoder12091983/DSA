...
// TODO fix of movement of pointers like we move j poiner as long as maxLetters is in range
// but we need to consider maxsize as well
    ...
    public int maxFreq(String s, int maxLetters, int minSize, int maxSize) {
        ...
        while(j < n) {
            ...
            if(c <= maxLetters) {
                ...
                int len = j - i - 1;
                if(c <= maxLetters && len >= minSize && len <= maxSize) {
