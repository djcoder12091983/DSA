import java.util.*; 
public class LCAQueryBinaryLifting { 
    ...
    { 
        ...
        // recursion formula to calculate 
        // the values of memo[][] 
        memo[u][0] = p; 
        for (int i = 1; i <= log; i++) 
    ...
    { 
        // node which is present farthest from the root node is taken as u 
        ...
        // ancestor of u hich is at same level as v 
        for (int i = log; i >= 0; i--) { 
        ...
        // node closest to the root which is not the common ancestor of u and v 
        ...
        // first ancestor of above found node 
        return memo[u][0]; 
    } 
